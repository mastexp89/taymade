      ...
      <div className="wrap foot">
        <div>
          ...
          <div className="socials">
            <a href={content.instagram} aria-label="Instagram">
        ...
        <div>
          ...
          <div className="contact-row">
            ...
            <span>{content.addressLine1}<br />{content.addressLine2}</span>
          </div>
          <div className="contact-row">
          ...
          <div className="contact-row">
            ...
            <span>{content.hours1}<br />{content.hours2}</span>
          </div>
        </div>
